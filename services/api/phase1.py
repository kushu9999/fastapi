...
@app.get("/blog9/all", tags=['response description'], summary="Response description", description="This api simulates fetching all blogs", response_description="The list of available blogs")
def get_blog_with_summary():
    return {'message': 'This api simulates fetching all blogs'}